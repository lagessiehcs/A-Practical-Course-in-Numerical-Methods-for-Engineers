...
test_error        = {'001: !!! Testing function: <Fkt 0    : falcutaet(0)>                                                   ... failed (error occured within function)!\n'
                     ...
                     '025: !!! Testing function: <Fkt XII  : BDF2(0.2,[1.1],[1.4],[1.7],[2.0,2.1]), LHS>                     ... failed (error occured within function)!\n'
                     '026: !!! Testing function: <Fkt XII  : BDF2(0.2,[1.1],[1.4],[1.7],[2.0,2.1]), RHS>                     ... failed (error occured within function)!\n'
                     ''
                     ''
                     ''
